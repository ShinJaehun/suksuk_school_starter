...
89. Planning manager는 자기 School archive를 read-only로 조회할 수 있지만 자신의 manager 지정·교체·해제, School lifecycle, actual rollover, global-admin-only system operation, generic `/admin/*` 또는 다른 School operation을 수행할 수 없다.
